...
<html>
    ...
    <body>
        ...
        <?php
            ...
            // SELECIONAR recuperar todos os registros da tabela tickets
            ...
            // DELETE dados enviados via GET para excluir registro
            if($_GET['id'] != ""){
        ...
        ?>
            ...
            ?>
                    ...
                    ?>
                            <td>
                                <a href="index.php?id="<?php echo $row["id"]?>">APAGAR</a>
                            </td>
